...
function buildGeneratePrompt(serviceType, content, msgLength = 'long') {
  const lengthRule = msgLength === 'short'
    ...
    : `2. 각 문안은 오프닝, 화제 제기, 실제 내용 및 제안, 행동 촉구의 네 영역을 모두 합한 총 글자 수(공백 포함)가 **반드시 210자 이상, 350자 이하**가 되도록 풍부하고 상세하게 작성하세요. 210자 미만이거나 350자를 초과해서는 안 됩니다. 구체적인 성과와 따뜻한 감동 문구를 충분히 활용해 주세요.`;
  ...
  const referenceNotice = msgLength === 'short'
    ...
    : `* 주의: 아래 '참고 예시'와 비슷하게 구체적이고 풍성한 내용(210자 ~ 350자 범위 내)으로 작성해 주세요.`;
